...
[portal de dados abertos](https://dados.cvm.gov.br/dados/). Um reader por dataset, **38 no total**,
...
> ℹ️ **`FIE/MEDIDAS`** publica `.csv` **e** `.txt`; usamos o **`.txt`**, o formato que os 38
> compartilham.
