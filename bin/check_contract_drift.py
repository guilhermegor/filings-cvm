...
_UNEXPOSED_CONTRACTS: dict[str, FileContract] = {
	...
	"CadastroCiaAbertaReader": CAD_CIA_ABERTA,
...
_META_MEMBERS: dict[str, tuple[str, ...]] = {
	...
	# FRE shipped in four themed slices; all four are in, so this tuple now covers
	# every one of its 36 members.
	...
	"MetaCgvnCiaAbertaReader": ("CgvnCiaAbertaReader", "CgvnCiaAbertaPraticasReader"),
