"""CVM ITR CIA_ABERTA (mutações do patrimônio líquido (consolidado)) — ingestion (leitura) reader.
...
class ItrCiaAbertaDmplConReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_DMPL_con"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_DMPL_CON
