"""CVM ITR CIA_ABERTA (balanço patrimonial passivo (individual)) — ingestion (leitura) reader.
...
class ItrCiaAbertaBppIndReader(_BaseItrReader):
	"""Read this ITR CIA_ABERTA member into a typed DataFrame.

	Covers `balanço patrimonial passivo (individual)`.
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_BPP_ind"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_BPP_IND
	_DATE_COLS: ClassVar[tuple[str, ...]] = (
		"DT_REFER",
		"DT_FIM_EXERC",
	)
	_LABEL: ClassVar[str] = "balanço patrimonial passivo (individual)"
