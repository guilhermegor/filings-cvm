"""CVM ITR CIA_ABERTA (valor adicionado (consolidado)) — ingestion (leitura) reader.
...
class ItrCiaAbertaDvaConReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_DVA_con"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_DVA_CON
