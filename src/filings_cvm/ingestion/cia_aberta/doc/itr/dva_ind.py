"""CVM ITR CIA_ABERTA (valor adicionado (individual)) — ingestion (leitura) reader.
...
class ItrCiaAbertaDvaIndReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_DVA_ind"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_DVA_IND
