"""CVM ITR CIA_ABERTA (composição do capital) — ingestion (leitura) reader.
...
class ItrCiaAbertaComposicaoCapitalReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_composicao_capital"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_COMPOSICAO_CAPITAL
