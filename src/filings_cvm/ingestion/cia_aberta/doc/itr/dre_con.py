"""CVM ITR CIA_ABERTA (demonstração do resultado (consolidado)) — ingestion (leitura) reader.
...
class ItrCiaAbertaDreConReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_DRE_con"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_DRE_CON
