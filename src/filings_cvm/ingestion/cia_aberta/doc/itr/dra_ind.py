"""CVM ITR CIA_ABERTA (resultado abrangente (individual)) — ingestion (leitura) reader.
...
class ItrCiaAbertaDraIndReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_DRA_ind"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_DRA_IND
