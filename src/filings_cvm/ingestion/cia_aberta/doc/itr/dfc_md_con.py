"""CVM ITR CIA_ABERTA (fluxo de caixa, método direto (consolidado)) — ingestion (leitura) reader.
...
class ItrCiaAbertaDfcMdConReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_DFC_MD_con"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_DFC_MD_CON
