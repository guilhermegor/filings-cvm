"""CVM ITR CIA_ABERTA (fluxo de caixa, método indireto (consolidado)) — ingestion (leitura) reader.
...
class ItrCiaAbertaDfcMiConReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_DFC_MI_con"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_DFC_MI_CON
