"""CVM ITR CIA_ABERTA (fluxo de caixa, método direto (individual)) — ingestion (leitura) reader.
...
class ItrCiaAbertaDfcMdIndReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_DFC_MD_ind"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_DFC_MD_IND
