"""CVM ITR CIA_ABERTA (balanço patrimonial ativo (consolidado)) — ingestion (leitura) reader.
...
class ItrCiaAbertaBpaConReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_BPA_con"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_BPA_CON
