"""CVM ITR CIA_ABERTA (balanço patrimonial passivo (consolidado)) — ingestion (leitura) reader.
...
class ItrCiaAbertaBppConReader(_BaseItrReader):
	"""Read this ITR CIA_ABERTA member into a typed DataFrame.

	Covers `balanço patrimonial passivo (consolidado)`.
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_BPP_con"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_BPP_CON
	_DATE_COLS: ClassVar[tuple[str, ...]] = (
		"DT_REFER",
		"DT_FIM_EXERC",
	)
	_LABEL: ClassVar[str] = "balanço patrimonial passivo (consolidado)"
