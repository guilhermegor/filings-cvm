"""CVM ITR CIA_ABERTA (balanço patrimonial ativo (individual)) — ingestion (leitura) reader.
...
class ItrCiaAbertaBpaIndReader(_BaseItrReader):
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_BPA_ind"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_BPA_IND
