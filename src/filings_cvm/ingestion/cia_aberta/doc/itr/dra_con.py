"""CVM ITR CIA_ABERTA (resultado abrangente (consolidado)) — ingestion (leitura) reader.
...
class ItrCiaAbertaDraConReader(_BaseItrReader):
	"""Read this ITR CIA_ABERTA member into a typed DataFrame.

	Covers `resultado abrangente (consolidado)`.
	...
	_MEMBER_STEM: ClassVar[str] = "itr_cia_aberta_DRA_con"
	_CONTRACT: ClassVar[FileContract] = ITR_CIA_ABERTA_DRA_CON
	_DATE_COLS: ClassVar[tuple[str, ...]] = (
		"DT_REFER",
		"DT_INI_EXERC",
		"DT_FIM_EXERC",
	)
	_LABEL: ClassVar[str] = "resultado abrangente (consolidado)"
