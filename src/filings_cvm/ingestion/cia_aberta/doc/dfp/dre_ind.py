"""CVM DFP CIA_ABERTA (demonstração do resultado (individual)) — ingestion (leitura) reader.
...
class DfpCiaAbertaDreIndReader(_BaseDfpReader):
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_DRE_ind"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_DRE_IND
