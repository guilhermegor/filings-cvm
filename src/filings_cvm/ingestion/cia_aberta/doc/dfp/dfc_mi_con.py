"""CVM DFP CIA_ABERTA (fluxo de caixa, método indireto (consolidado)) — ingestion (leitura) reader.
...
class DfpCiaAbertaDfcMiConReader(_BaseDfpReader):
	"""Read this DFP CIA_ABERTA member into a typed DataFrame.

	Covers `fluxo de caixa, método indireto (consolidado)`.
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_DFC_MI_con"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_DFC_MI_CON
	_DATE_COLS: ClassVar[tuple[str, ...]] = (
		"DT_REFER",
		"DT_INI_EXERC",
		"DT_FIM_EXERC",
	)
	_LABEL: ClassVar[str] = "fluxo de caixa, método indireto (consolidado)"
