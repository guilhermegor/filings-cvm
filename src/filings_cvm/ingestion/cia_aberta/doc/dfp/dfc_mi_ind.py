"""CVM DFP CIA_ABERTA (fluxo de caixa, método indireto (individual)) — ingestion (leitura) reader.
...
class DfpCiaAbertaDfcMiIndReader(_BaseDfpReader):
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_DFC_MI_ind"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_DFC_MI_IND
