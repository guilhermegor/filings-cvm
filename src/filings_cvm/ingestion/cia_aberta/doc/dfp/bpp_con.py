"""CVM DFP CIA_ABERTA (balanço patrimonial passivo (consolidado)) — ingestion (leitura) reader.
...
class DfpCiaAbertaBppConReader(_BaseDfpReader):
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_BPP_con"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_BPP_CON
