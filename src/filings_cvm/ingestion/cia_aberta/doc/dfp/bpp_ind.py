"""CVM DFP CIA_ABERTA (balanço patrimonial passivo (individual)) — ingestion (leitura) reader.
...
class DfpCiaAbertaBppIndReader(_BaseDfpReader):
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_BPP_ind"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_BPP_IND
