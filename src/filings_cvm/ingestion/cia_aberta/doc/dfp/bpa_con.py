"""CVM DFP CIA_ABERTA (balanço patrimonial ativo (consolidado)) — ingestion (leitura) reader.
...
class DfpCiaAbertaBpaConReader(_BaseDfpReader):
	"""Read this DFP CIA_ABERTA member into a typed DataFrame.

	Covers `balanço patrimonial ativo (consolidado)`.
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_BPA_con"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_BPA_CON
	_DATE_COLS: ClassVar[tuple[str, ...]] = (
		"DT_REFER",
		"DT_FIM_EXERC",
	)
	_LABEL: ClassVar[str] = "balanço patrimonial ativo (consolidado)"
