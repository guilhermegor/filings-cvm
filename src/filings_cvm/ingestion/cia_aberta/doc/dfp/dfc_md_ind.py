"""CVM DFP CIA_ABERTA (fluxo de caixa, método direto (individual)) — ingestion (leitura) reader.
...
class DfpCiaAbertaDfcMdIndReader(_BaseDfpReader):
	"""Read this DFP CIA_ABERTA member into a typed DataFrame.

	Covers `fluxo de caixa, método direto (individual)`.
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_DFC_MD_ind"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_DFC_MD_IND
	_DATE_COLS: ClassVar[tuple[str, ...]] = (
		"DT_REFER",
		"DT_INI_EXERC",
		"DT_FIM_EXERC",
	)
	_LABEL: ClassVar[str] = "fluxo de caixa, método direto (individual)"
