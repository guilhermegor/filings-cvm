"""CVM DFP CIA_ABERTA (resultado abrangente (individual)) — ingestion (leitura) reader.
...
class DfpCiaAbertaDraIndReader(_BaseDfpReader):
	"""Read this DFP CIA_ABERTA member into a typed DataFrame.

	Covers `resultado abrangente (individual)`.
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_DRA_ind"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_DRA_IND
	_DATE_COLS: ClassVar[tuple[str, ...]] = (
		"DT_REFER",
		"DT_INI_EXERC",
		"DT_FIM_EXERC",
	)
	_LABEL: ClassVar[str] = "resultado abrangente (individual)"
