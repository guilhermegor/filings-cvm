"""CVM DFP CIA_ABERTA (mutações do patrimônio líquido (individual)) — ingestion (leitura) reader.
...
class DfpCiaAbertaDmplIndReader(_BaseDfpReader):
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_DMPL_ind"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_DMPL_IND
