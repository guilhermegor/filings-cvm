"""CVM DFP CIA_ABERTA (balanço patrimonial ativo (individual)) — ingestion (leitura) reader.
...
class DfpCiaAbertaBpaIndReader(_BaseDfpReader):
	"""Read this DFP CIA_ABERTA member into a typed DataFrame.

	Covers `balanço patrimonial ativo (individual)`.
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_BPA_ind"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_BPA_IND
	_DATE_COLS: ClassVar[tuple[str, ...]] = (
		"DT_REFER",
		"DT_FIM_EXERC",
	)
	_LABEL: ClassVar[str] = "balanço patrimonial ativo (individual)"
