"""CVM DFP CIA_ABERTA (valor adicionado (consolidado)) — ingestion (leitura) reader.
...
class DfpCiaAbertaDvaConReader(_BaseDfpReader):
	"""Read this DFP CIA_ABERTA member into a typed DataFrame.

	Covers `valor adicionado (consolidado)`.
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_DVA_con"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_DVA_CON
	_DATE_COLS: ClassVar[tuple[str, ...]] = (
		"DT_REFER",
		"DT_INI_EXERC",
		"DT_FIM_EXERC",
	)
	_LABEL: ClassVar[str] = "valor adicionado (consolidado)"
