"""CVM DFP CIA_ABERTA (resultado abrangente (consolidado)) — ingestion (leitura) reader.
...
class DfpCiaAbertaDraConReader(_BaseDfpReader):
	...
	_MEMBER_STEM: ClassVar[str] = "dfp_cia_aberta_DRA_con"
	_CONTRACT: ClassVar[FileContract] = DFP_CIA_ABERTA_DRA_CON
