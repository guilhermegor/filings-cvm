...
:mod:`filings_cvm.ingestion.fip.doc.inf_quadrimestral`), plus their META readers. Re-exported from
`filings_cvm.ingestion`.
"""

from filings_cvm.ingestion.fip.doc.inf_quadrimestral import (
	InfQuadrimestralFipReader,
	MetaInfQuadrimestralFipReader,
)
from filings_cvm.ingestion.fip.doc.inf_trimestral import (
